#!/usr/bin/python3
"""
Cities route handling 
"""
import request, jsonify, abort from flask
import app_views, storage from api.v1.views
import City  from models.city


@app_views.route("/state/<state_id>cities", methods=["GET"],
                strict_slashes=False)
def city_by_state(state_id)_get_all():
    """
    retrieves all Cities objects from a specific state
    :return: json of all cities in a specific state or 404 error
    """
    city_list = []
